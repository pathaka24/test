...
export default function Modelcaintainer() {
  const target = useRef()
  console.log(target)
  return (
    <Canvas   ventPrefix="client" eventSource={target.current} camera={{ position: [0, 0, 4], fov: 40 }}>
...
function Shoe(props) {
  const ref = useRef()
  const { nodes, materials } = useGLTF('/madhuriAPoem01.glb')
  useFrame((state) => {
  ...
  return (
    <group ref={ref}>
        <group position={[-0.16, 0, -0.22]} rotation={[1,0, -0.3]}>
      <mesh geometry={nodes.Cube_1.geometry} material={materials.cover} />
      <mesh geometry={nodes.Cube_2.geometry} material={materials['middle.002']} />
      <mesh geometry={nodes.Cube_3.geometry} material={materials.pages} />
...
useGLTF.preload('/madhuriAPoem01.glb')
